return {
  ...
  keys = {
    ...
    { "<leader>wk", function() require("smart-splits").swap_buf_up() end, mode = { "n", "x" }, desc = "Swap buffer up" },
    { "<leader>wl", function() require("smart-splits").swap_buf_right() end, mode = { "n", "x" }, desc = "Swap buffer right" },
  },
  cmd = {
    "SmartCursorMoveDown", "SmartCursorMoveLeft", "SmartCursorMoveRight", "SmartCursorMoveUp",
    "SmartResizeDown", "SmartResizeLeft", "SmartResizeMode", "SmartResizeRight", "SmartResizeUp",
    "SmartSplitsLog", "SmartSplitsLogLevel",
  },
  init = function()
